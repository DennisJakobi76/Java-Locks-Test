...
//        t2.join();
        ...
        Thread writerThread = new Thread(() -> readWriteLock.write(49), "Writer Thread");
        Thread reader1 = new Thread(readWriteLock::read, "Reader 1");
        Thread reader2 = new Thread(readWriteLock::read, "Reader 2");
